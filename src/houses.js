...
// town again, in another form, to watch the pollen above their own roof is
// asking twice for something we can read. This module is the one place that
// reads it, and "Add my Gladys houses" is the button that turns it into
// locations.
//
